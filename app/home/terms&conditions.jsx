...
const blogData = [{
    ...
    paragraph: 'Users are required to register on the Salon ZenStyle website to book appointments. The registration process involves providing personal information such as name, contact number, email address, residential address, postal code, and city. Verification of the user\'s mobile number is necessary to activate the account.',
    date: '11th Jan 2022',
}, {
    id: '2',
    ...
    paragraph: 'Specific services such as hair coloring, straightening, keratin treatments, and facials include a mandatory, free allergy test that must be conducted at least two days before the scheduled service. Salon ZenStyle will not be held responsible for any adverse effects or medical conditions that arise due to treatments administered at the salon or resulting from failure to conduct the allergy tests.',
    date: '24th Sept 2021',
}, {
    id: '5',
    ...
    paragraph: 'In the event of a dispute, customers are encouraged to contact our customer service team through the provided hotline or email. Salon ZenStyle commits to resolving disputes amicably and efficiently.',
    date: '24th Sept 2021',
}, {
    id: '7',
    title: '7) Modifications to Terms',
    paragraph: 'Salon ZenStyle reserves the right to amend these terms and conditions at any time. All changes will be effective immediately upon their posting on the website. Continued use of the booking system after any changes constitutes acceptance of the new terms.',
    date: '24th Sept 2021',
}, {
    id: '8',
    ...
    paragraph: 'Salon ZenStyle operates in compliance with applicable local and national laws. Users agree to not use the booking system for any unlawful activities.',
    date: '24th Sept 2021',
},];
